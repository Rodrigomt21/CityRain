...
async def list_captures(
    ...
    weather_label: Optional[str] = Query(default=None, description="Filtrar por label"),
    ...
    return await service.list_captures(skip, limit, weather_label, from_date, to_date)
