...
class _MotorTorch:
    ...
    def __init__(self, caminho_modelo, usar_gpu=True):
        ...
        # torchvision instalado nesta Jetson segfalta em qualquer `import
        # torchvision` (Python 3.6 + torchvision/datasets/fgvc_aircraft.py
        # usa `from __future__ import annotations`, so valido a partir do
        # 3.7). Usamos so a arquitetura MobileNetV2 vendorizada, que nao
        # depende do pacote torchvision inteiro.
